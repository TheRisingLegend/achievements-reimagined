#ifndef SHARDACHIEVEMENTPOPUP_HPP
#define SHARDACHIEVEMENTPOPUP_HPP

#include <Geode/Geode.hpp>

#include "AchievementCategoryPopup.hpp"

class ShardAchievementPopup : public AchievementCategoryPopup {
   protected:
   ...
   public:
    static ShardAchievementPopup* create(AchievementMenu* achievementMenu, Category* category);
